; ModuleID = 'probe6.2c151a711d404fce-cgu.0'
source_filename = "probe6.2c151a711d404fce-cgu.0"
target datalayout = "e-m:e-p:64:64-i64:64-n32:64-S128"
target triple = "sbf"

; core::f64::<impl f64>::is_subnormal
; Function Attrs: inlinehint nounwind
define internal zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17h8fbc2add70bffd91E"(double %self) unnamed_addr #0 {
start:
...
define hidden void @_ZN6probe65probe17hddfa85c1a934af77E() unnamed_addr #1 {
start:
; call core::f64::<impl f64>::is_subnormal
  %_1 = call zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17h8fbc2add70bffd91E"(double 1.000000e+00) #2
  ret void
}
